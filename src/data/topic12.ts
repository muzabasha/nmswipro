...
export const topic12Data: TopicData = {
  ...
  storytelling: {
    ...
    story: "In any complex system, components must communicate. Just as a manager oversees employees, a central system oversees network nodes. This topic explores SNMP Limitations and Operators Requirement.",
